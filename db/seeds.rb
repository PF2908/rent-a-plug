...
ad = Ad.new(
  ...
  cable_length: 100, brand: 'Belkino', number_of_plug: 6, user: user, description: "dskjvndfjkh  zifghfe ije kjgh dkjdkkj jkj erghjdf jk hvdfkjfgb kjgdbkjnb kjh kh ekdghbv kjdhfg kh ", price: 12.50
)
